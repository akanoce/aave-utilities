    ...
    constructor(provider, contractFactory) {
        ...
        this.generateTxCallback = ({ rawTxMethod, from, value, gasSurplus, action, }) => async () => {
            ...
            try {
                ...
                tx.gasLimit = ethers_1.BigNumber.from(action ? utils_1.gasLimitRecommendations[action].recommended : utils_1.gasLimitRecommendations[types_1.ProtocolAction.default].recommended);
            }
            if (action &&
